    ...
    return(
        <>
            <div className='ownerInfo'>
                ...
                <img className='educationImg' src="ownerInfo/img4.jpg" alt="" />
                <p className='headingEdu1'>Founder Education</p>

                <div className='ownerContent'>
                <p className='headingEdu2'>Schooling</p>
                <p>Sharada Vidya Mandira, Kadugodi, Bangalore - 560067</p>

                <p className='headingEdu2'>College</p>
                <p>MVJ PU College, Channasandran Bangalore - 560068</p>

                <p className='headingEdu2'>Graduation</p>
                <p>Indian Institute of Information Technology Design and Manufacturing, Chennai - 600981</p>
                </div>
                </div>
            </div>
        </>
